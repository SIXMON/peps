...
SURFACE_TYPE = (
    ("Toutes les surfaces potentiellement adaptées à la mise en place de la pratique", "Toutes les surfaces potentiellement adaptées à la mise en place de la pratique"),
